...
CONTRACT = "0xDFFCF322FB8D48a8f9f9b08A16D46a0C537F3c73" # segundo requisito
...
function_data = contract.functions.guardarSaludo("Hola desde python 2").build_transaction({
